  ...
  function(){
    ...
    $.get(
        ...
        function(data){
            ...
            var module_1 = $("#module_1").val().split(",");  
            html = '';          
            for(var i in module_1){
                v = module_1[i];                
            ...
            var module_2 = $("#module_2").val().split(",");            
            html = '';
            for(var i in module_2){
                v = module_2[i];                
                if(v!=null && v.length>0){
                        html = html+v+"<br>";
                }                
            ...
            var module_3 = $("#module_3").val().split(",");     
            html = '';       
            for(var i in module_3){
                v = module_3[i];                
                if(v!=null && v.length>0){
                        html = html+v+"<br>";
                }                
            ...
            var module_4 = $("#module_4").val().split(",");   
            html = '';         
            for(var i in module_4){
                v = module_4[i];                
                if(v!=null && v.length>0){
                        html = html+v+"<br>";
                }                
            ...
            var module_5 = $("#module_5").val().split(",");      
            html = '';      
            for(var i in module_5){
                v = module_5[i];                
                if(v!=null && v.length>0){
                        html = html+v+"<br>";
                }                

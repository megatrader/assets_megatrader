...
var uploader_image = $("#uploader_image");
var image = $("#image");
var image_code = $("#image_code");
var url_image = $("#url_image").attr("data-url");
var progress_image = $("#progress_image");

var button_logo = $("#button_logo");
var uploader_logo = $("#uploader_logo");
var logo = $("#logo");
var logo_code = $("#logo_code");
var url_logo = $("#url_logo").attr("data-url");
var progress_logo = $("#progress_logo");
...
$(
  function(){
      ...
      $(button_logo).click(
            function(event){
              if($(progress_logo).length>0){
                  $($(progress_logo).find(".progress-bar")).css('width','0%');
              }
            }
      );
      $(uploader_logo).fileupload(
          {
              ...
              progressall: function (e, data) {
                  var progress = parseInt(data.loaded / data.total * 100, 10);
                  $($(progress_logo).find(".progress-bar")).css('width',progress+'%');
              }
          }
      ).prop('disabled', !$.support.fileInput).parent().addClass($.support.fileInput ? undefined : 'disabled');
